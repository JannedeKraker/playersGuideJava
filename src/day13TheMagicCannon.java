...
// has constructed a magic cannonthat draws power from two gems:
// a fire gem and an electric gem. Every thirdturn of a crank, the fire gem activates,
// and the cannon produces a fire blast.The electric gem activates every fifth turn of the crank,
// and the cannon makesan electric blast. When the two line up, it generates a potent combined blast.
