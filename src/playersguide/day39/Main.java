...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Menu.show(Menu.startMenu());
        ; // hier word een keer het start menu laten zien met alle commando's
        ...
        player.setEndTime();
        System.out.println("Your time spend at the grid is: " + player.getDuration());
    }
}
